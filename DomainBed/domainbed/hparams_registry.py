...
def _hparams(algorithm, dataset, random_seed):
    ...
    if algorithm in ['DANN', 'CDANN']:
        ...
        _hparam('feat_lambda', 1, lambda r: 10**r.uniform(-1., 1.))
        _hparam('grad_lambda', 1000, lambda r: 10**r.uniform(1., 5.))
        _hparam('grad_penalty_anneal_iters', 1500, lambda r: int(r.uniform(0., 5000.)))
